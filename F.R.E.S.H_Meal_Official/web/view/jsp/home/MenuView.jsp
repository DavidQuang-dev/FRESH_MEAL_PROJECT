                    ...
                    <c:if test="${listOfCategory != null}">
                        <div class="menu-option">
                            <a href="DispatchServlet?btAction=WeeklyPlanProduct&weeklyPlanId=${WeeklyPlanID}">
                                <img src="view/Assets/Images/food category/Noodle.png" alt=""/>
                            </a>
                            <h4>All</h4>
                        </div>
            ...
            <div class="menu-flex">
                <div class="menu-filter">
                    <div class="menu-filter-block">
                        ...
                        <div class="menu-filter-container">
                            <!--                            <div class="filter-option">
                                                            <a href="DispatchServlet?btAction=AllTimeSelection&categoryName=${CategoryName}&weeklyPlanId=${WeeklyPlanID}" class="filter-link" data-group="time" data-type="all">
                                                                <span class="radio-circle "></span>All
                                                            </a>
                                                        </div>-->
                            <div class="filter-option">
                    ...
                    <div class="menu-filter-block">
                        ...
                        <div class="menu-filter-container">
                            <!--                            <div class="filter-option">
                                                            <a href="DispatchServlet?btAction=AllPriceSelection&categoryName=${CategoryName}&weeklyPlanId=${WeeklyPlanID}" class="filter-link" data-group="price" data-type="all">
                                                                <span class="radio-circle "></span>All
                                                            </a>
                                                        </div>-->
                            <div class="filter-option">
                                    ...
                                    <div class="menu-box">
                                        <a href="DispatchServlet?btAction=MenuInfo&productId=${p.productID}">
                                            ...
                                            <div class="menu-min-price">
                                                ...
                                                <small class="menu-price">  ${p.getPrice()}</small>
                                            </div>
                                        </a>
                                    </div>
                                </c:forEach>
                                    ...
                                    <div class="menu-box">
                                        <a href="DispatchServlet?btAction=MenuInfo&productId=${p.productID}">
                                            ...
                                            <div class="menu-min-price">
                                                ...
                                                <small class="menu-price">  ${p.getPrice()}đ</small>
                                            </div>
                                        </a>
                                    </div>
                                </c:forEach>
