                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table
                                            class="table table-bordered table-striped orderTable"
                                            >
                                            <thead>
                                                <tr>
                                                    <th>ID Order</th>
                                                                ...
                                                                <div class="item-container">
                                                                    ...
                                                                    <div class="side-content">
                                                                        <div class="main-order-content">
                                                                            ...
                                                                            <div class="order-price-item"><%= orderDetails.getPrice() * orderDetails.getQuantity()%></div>
                                                                        </div>
                                                                ...
                                                                <div class="sub-sumary">
                                                                    ...
                                                                    <div class="sub-sumary-contain">
                                                                        <div class="sumary-subtotal">
                                                                            ...
                                                                            <div class="subtotal-price"><%= subtotal%>đ</div>
                                                                        </div>
                                                                        <div class="sumary-discription">
                                                                            <small class="sumary-subtext">Discount</small>
                                                                            <small class="sumary-price">- <%= order.getDiscount()%>đ</small>
                                                                        </div>
                                                                        <div class="sumary-discription">
                                                                            <small class="sumary-subtext">Delivery</small>
                                                                            <small class="sumary-price">+ <%= delivery.getDeliveryPrice()%>đ</small>
                                                                        </div>
                                                                        <div class="sumary-discription">
                                                                            <small class="sumary-subtext">Tax</small>
                                                                            <small class="sumary-price">+ <%= order.getTax()%>đ</small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="order-sumary-total">
                                                                    <div class="sumary-total-text">Total</div>
                                                                    <div class="total-price"><%= order.getTotalPrice()%>đ</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
