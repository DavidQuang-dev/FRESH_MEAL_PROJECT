...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="DispatchServlet?btAction=welcomeAdmin" class="brand-link">
        <img src="view/Assets/Images/logo.png" alt="FreshMeal Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="view/Assets/Images/user/user1.jpg" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
