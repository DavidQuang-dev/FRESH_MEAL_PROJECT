                        ...
                        <div class="method-contain">
                            ...
                            <div class="order-sumary">
                                ...
                                <div class="order-sumary-contain">
                                        ...
                                        <div class="sub-sumary-contain">
                                            ...
                                            <div class="sumary-discription">
                                                ...
                                                <c:if test="${requestScope.DISCOUNT != null}">
                                                    <small class="sumary-price">- ${requestScope.DISCOUNT}đ</small>
                                                </c:if>
                                                <c:if test="${requestScope.DISCOUNT == null}">
                                                    <small class="sumary-price">0 VND</small>
                                                </c:if>
                                            </div>
                                            <div class="sumary-discription">
                                                <small class="sumary-subtext">Delivery</small>
                                                <small class="sumary-price">${requestScope.DELIVERYPRICE}đ</small>
                                            </div>
                                            <div class="sumary-discription">
                                    ...
                                    <div class="order-sumary-total">
                                        ...
                                        <div class="total-price">${requestScope.TOTALPRICE}đ</div>
                                    </div>
                                </div>
                            </div>
                            <form action="DispatchServlet" method="POST">
                                <div class="method-button">
                                    ...
                                    <input type="hidden" name="discount" value="20000"/>
