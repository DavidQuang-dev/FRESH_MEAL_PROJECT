                                        ...
                                        <div class="address-group">
                                            ...
                                            <c:if test="${ListOfAddressOfUser != null}">
                                                <c:forEach var="address" items="${ListOfAddressOfUser}">
                                                    <div class="address-contain" data-address-id="1">
                                                        <div class="address-main">
                                                            <div class="stardust-radio" role="radio">
                                                                <input type="radio" name="selectedAddress" value="${address.addressID}" <c:if test="${selectedAddress == address.addressID}">checked=""</c:if>/> 
