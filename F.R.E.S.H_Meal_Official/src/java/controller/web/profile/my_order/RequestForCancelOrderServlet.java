...
public class RequestForCancelOrderServlet extends HttpServlet {
    ...
    private final String PROFILE_MY_CANCEL_ORDER_PAGE = "DispatchServlet?btAction=CancelOrder";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                if (rs >= 1) {
                    request.setAttribute("Notification", "you have canceled the order" + orderID);
