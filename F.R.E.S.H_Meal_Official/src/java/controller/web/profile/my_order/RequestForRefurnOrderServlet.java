...
public class RequestForRefurnOrderServlet extends HttpServlet {
    ...
    private final String PROFILE_MY_REFURN_ORDER_PAGE = "DispatchServlet?btAction=RefurnOrder";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                if (rs >= 1) {
                    request.setAttribute("Notification", "Your order" + orderID + "is waiting to accept Refurn");
                    response.sendRedirect(PROFILE_MY_ORDER_PAGE);
                } else {
