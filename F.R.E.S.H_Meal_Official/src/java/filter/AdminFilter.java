...
public class AdminFilter implements Filter {
     ...
     */
    private final String HOME_PAGE = "DispatchServlet";
    private final String ADMIN_HOME_PAGE = "DispatchServlet?btAction=welcomeAdmin";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session.getAttribute("account") == null) {
            ...
            if (user.getRoleID() != 2) {
                ...
                req.getRequestDispatcher(ADMIN_HOME_PAGE).forward(request, response);
            }
        }
